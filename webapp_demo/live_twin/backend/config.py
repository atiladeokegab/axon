...
# shoulder abduction excursions of 25-45 deg on a motionless subject. Those
# frames are better dropped than filtered: a dropped frame ages out and stops
# stimulation, whereas a confidently wrong one is acted upon.
